...
from .background_process import exec_with_logging

'''
This wrapper is from https://github.com/elifesciences/sciencebeam-parser
https://github.com/elifesciences/sciencebeam-parser/blob/03229401909df3ded46aab8dc2eb10a614a87033/sciencebeam_parser/external/pdfalto/wrapper.py
author: Daniel Ecer @de-code
MIT License  
'''
